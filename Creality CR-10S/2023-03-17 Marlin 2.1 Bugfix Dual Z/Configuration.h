...
#define STRING_CONFIG_H_AUTHOR "(MBM, CR-10S)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V3_0  // MBM for SKR 3
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1  // MBM In case we want a TFT
...
//#define CUSTOM_MACHINE_NAME "CR-10S SKR3"
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // MBM
#define Y_DRIVER_TYPE  TMC2209 // MBM
#define Z_DRIVER_TYPE  TMC2209 // MBM
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209 // MBM Dual Z steppers
...
#define E0_DRIVER_TYPE TMC2209  // MBM
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  13.7  // MBM
    #define DEFAULT_Ki   0.77 // MBM
    #define DEFAULT_Kd  60.61 // MBM
  #endif
#endif
...
//#define ENDSTOPPULLUPS  // MBM
#if DISABLED(ENDSTOPPULLUPS)
  // Disable ENDSTOPPULLUPS to set pullups individually
  #define ENDSTOPPULLUP_XMIN // MBM
  #define ENDSTOPPULLUP_YMIN // MBM
...
#define Z_MIN_ENDSTOP_INVERTING true // MBM Set to true to invert the logic of the endstop.
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // MBM Set to true to invert the logic of the probe.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 837 }  // MBM
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 100, 25 }  // MBM
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 }  // MBM
 ...
 */
#define DEFAULT_ACCELERATION          600    // MBM X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1000    // MBM E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   800    // MBM X, Y, Z acceleration for travel (non printing) moves
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.067 // MBM (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 45, 5, 0 }  // MBM Titan Aero per filename +45x +5Y

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 20  // MBM

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (8*60)  // MBM
...
#define Z_AFTER_PROBING           5 // MBM Z position after probing is done
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // MBM
...
#define Z_HOMING_HEIGHT  4      // (MBM mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING  5      // MBM (mm) Height to move to after homing Z
...
#define X_BED_SIZE 293// MBM Measured using https://manuelmclure.github.io/ConfiguringLeveling.html
#define Y_BED_SIZE 290 // MBM As far as Y will go, tested using https://manuelmclure.github.io/ConfiguringLeveling.html

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE // MBM 15mm Extra space on the right end
#define Y_MAX_POS Y_BED_SIZE // MBM 4mm Extra space behind the bed
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM  // MBM Enable/Disable software endstops from the LCD
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_STATE     HIGH        // MBM Pin state indicating that filament is NOT present.
...
#define AUTO_BED_LEVELING_UBL  // MBM
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  // MBM
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION  // MBM
  #if ENABLED(G26_MESH_VALIDATION)
    #define MESH_TEST_NOZZLE_SIZE    0.4  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.2  // (mm) Default layer height for G26.
    #define MESH_TEST_HOTEND_TEMP  210    // MBM (°C) Default nozzle temperature for G26.
    #define MESH_TEST_BED_TEMP      60    // (°C) Default bed temperature for G26.
    #define G26_XY_FEEDRATE         60    // MBM (mm/s) Feedrate for G26 XY moves.
  ...
  #define GRID_MAX_POINTS_X 4  // MBM
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID  // MBM
  ...
  #define MESH_EDIT_GFX_OVERLAY   // MBM Display a graphics overlay while editing the mesh

  #define MESH_INSET 20              // MBM Set Mesh bounds as an inset region of the bed
  ...
  #define UBL_MESH_WIZARD         // MBM Run several commands in a row to get a complete mesh
 ...
 */
//#define LCD_BED_LEVELING  // MBM

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // MBM Add a menu to edit mesh points
#endif
...
#define MANUAL_Y_HOME_POS -13 // MBM - for Aero Evolve
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (8*60) }  // MBM
 ...
 */
#define EEPROM_SETTINGS     // MBM Persistent storage with M500 and M501
...
#define PREHEAT_1_TEMP_HOTEND 210  // MBM
#define PREHEAT_1_TEMP_BED     60  // MBM
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG"  // MBM
#define PREHEAT_2_TEMP_HOTEND 245     // MBM
#define PREHEAT_2_TEMP_BED    60      // MBM
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 20 } // MBM
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  // MBM
