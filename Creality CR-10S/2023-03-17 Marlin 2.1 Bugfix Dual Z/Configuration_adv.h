 ...
 */
   ...
   #define THERMAL_PROTECTION_PERIOD 90        // MBM Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 10     // MBM Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  90               // MBM Seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        180 // MBM Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS     5 // MBM Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                120 // MBM Seconds
...
#define QUICK_HOME                          // MBM If G28 contains XY do a diagonal move first
...
//
#define ASSISTED_TRAMMING // MBM
#if ENABLED(ASSISTED_TRAMMING)

  // Define from 3 to 9 points to probe.
  // MBM It looks like you have to account for the probe offset, which is 45 to the right and 5 to the rear.
  // MBM The probe is more or less where we want it at home position.
  // Good info:  https://github.com/MarlinFirmware/Marlin/issues/21013#issuecomment-1209280075																											
  #define TRAMMING_POINT_XY { {  0+45, 20+5 }, { 280-45,  20+5 }, { 280-45, 270-5 }, { 0+45, 270-5 } }  // MBM
  ...
  #define REPORT_TRAMMING_MM          // MBM Report Z deviation (mm) for each point relative to the first

  #define ASSISTED_TRAMMING_WIZARD    // MBM Add a Tramming Wizard to the LCD menu
 ...
 */
#define INPUT_SHAPING_X  // MBM Disable for SKR 1.3 on CR-10S
#define INPUT_SHAPING_Y  // MBM Disable for SKR 1.3 on CR-10S
  ...
  #define SHAPING_MENU                // MBM Add a menu to the LCD to set shaping parameters.
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // MBM Add a Probe Z Offset calibration option to the LCD menu
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 3000       // MBM (ms) Total Duration to display the boot screen(s)
  ...
  #define STATUS_MESSAGE_SCROLLING  // MBM
...
#define SET_PROGRESS_MANUALLY    // MBM
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // MBM Display estimated time to completion (prefix 'R')
   ...
   */
  //#define SDCARD_SORT_ALPHA  // MBM Disabled
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // MBM Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  #define LONG_FILENAME_WRITE_SUPPORT   // MBM Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // MBM Scroll long filenames in the SD card menu
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  // MBM for SKR boards
...
#define BABYSTEPPING                         // MBM
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  5       // MBM (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 5       // MBM (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  //  MBM Double-click on the Status Screen for Z Babystepping.
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 1250   // Maximum interval between clicks, in milliseconds.
                                            // Note: Extra time may be added to mitigate controller latency.
    #define MOVE_Z_WHEN_IDLE              // MBM Jump to the move Z menu on doubleclick when printer is idle.
    #if ENABLED(MOVE_Z_WHEN_IDLE)
      #define MOVE_Z_IDLE_MULTIPLICATOR 1   // Multiply 1mm by this factor for the move step size.
    #endif
  #endif

  #define BABYSTEP_DISPLAY_TOTAL          // MBM Display total babysteps since last G28
 ...
 */
#define LIN_ADVANCE               // MBM
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.0 }    // MBM (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.0       // MBM (mm) Compression length applying to all extruders
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define ALLOW_LOW_EJERK       // MBM Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends.
 ...
 */
  ...
  #define MESH_MIN_X MESH_INSET   // MBM
  #define MESH_MIN_Y MESH_INSET   // MBM
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET)  // MBM
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET)  // MBM
#endif
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 64  // MBM
#else
  #define BLOCK_BUFFER_SIZE 64  // MBM
#endif
...
#define TX_BUFFER_SIZE 64  // MBM was 0

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
//#define RX_BUFFER_SIZE 2048  // MBM
 ...
 */
#define ADVANCED_PAUSE_FEATURE   // MBM
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     40  // MBM (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     2  // MBM (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   40  // MBM (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     50  // MBM (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH         20  // MBM (mm) Length to extrude after loading.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       4  // (MBM mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY       5000  // (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH         0  // MBM (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      25  // (mm/s) feedrate to purge before unload

  #define PAUSE_PARK_NOZZLE_TIMEOUT           120  // MBM (seconds) Time limit before the nozzle is turned off for safety.
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                    // MBM Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // MBM Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.8  // MBM Scales down the holding current from run current
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       800        // MBM (mA) RMS current. Multiply by 1.414 for peak current.
   ...
   */
  #define MONITOR_DRIVER_STATUS  // MBM
...
#define M114_DETAIL         // MBM Use 'M114` for details to check planner calculations
...
#define MEATPACK_ON_SERIAL_PORT_1   // MBM
 ...
 */
#define HOST_ACTION_COMMANDS   // MBM
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           // MBM Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM          // MBM Add a menu item that tells the host to start
