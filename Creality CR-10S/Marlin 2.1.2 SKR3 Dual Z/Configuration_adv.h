 ...
 */
//#define Z_STEPPER_AUTO_ALIGN  // MBM Disabled for testing
   ...
   */
  //#define Z_STEPPER_ALIGN_XY { {  20, 150 }, { 280,  150 } }  // MBM COMMENTED
 ...
 */
#define INPUT_SHAPING_X  // MBM
#define INPUT_SHAPING_Y  // MBM
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  // mbm
...
// G2/G3 Arc Support
//
//#define ARC_SUPPORT                   // MBM Requires ~3226 bytes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            2  // MBM (mm) Initial retract.
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // MBM (mm) The length of filament for a complete unload.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           60  // MBM (seconds) Time limit before the nozzle is turned off for safety.
  ...
  //#define HOME_BEFORE_FILAMENT_CHANGE             // MBM If needed, home before parking for filament change
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_RSENSE          0.11      // MBM Multiplied x1000 for TMC26X62
...
//#define MEATPACK_ON_SERIAL_PORT_2 // MBM
