 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD       60 // MBM Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS     10 // MBM Degrees Celsius
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 200-23,  20 }, { 200-23, 200-43}, { 20, 200-43 } }
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32  // MBM
#else
  #define BLOCK_BUFFER_SIZE 32   // MBM
#endif
...
#define ADVANCED_PAUSE_FEATURE  // MBM
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      50  // MBM (mm) The length of filament for a complete unload.
